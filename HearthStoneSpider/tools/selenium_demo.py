...
with open('e:/cookies.json', 'r') as f:
...
with open('e:/cookies2.json', 'w') as f:
    f.write(jsonCookies)
# langToggle = browser.find_elements_by_css_selector('.dropdown-toggle')[0]
# langToggle.click()
# time.sleep(1)
# langItemEn = browser.find_elements_by_css_selector('.dropdown-menu li')[0]
# langItemEn.click()
# time.sleep(1)
# dictCookies = browser.get_cookies()
# jsonCookies = json.dumps(dictCookies)
# with open('e:/cookies3.json', 'w') as f:
#     f.write(jsonCookies)
# 登录会员
...
# browser.find_element_by_css_selector(".controls input[name='accountName']").send_keys('yf381966217@163.com')
